...
const items=[{href:"/app",label:"Bosh sahifa",Icon:Home},{href:"/app/ombor",label:"Ombor",Icon:Box},{href:"/app/sotish",label:"Savdo",Icon:WalletCards},{href:"/app/hisobot",label:"Hisobot",Icon:BarChart3},{href:"/app/boshqaruv",label:"Profil",Icon:Box}];
